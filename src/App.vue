              ...
              <Menu mode="horizontal" width="auto" @on-select="changelanguage" style="height: 50px;line-height:50px;">
                  <Submenu name="lang">
                      <template slot="title" class="lang-title">
                        ...
                        <img class="lang-img" v-if="lang=='简体中文'" src="./assets/images/lang-zh.png">
                        <img class="lang-img" v-if="lang=='English'" src="./assets/images/lang-en.png">
                      </template>
                      <MenuItem name="zh" class="lang-item"><img src="./assets/images/lang-zh.png">简体中文</MenuItem>
                      <MenuItem name="en" class="lang-item"><img src="./assets/images/lang-en.png">ENGLISH</MenuItem>
                  </Submenu>
              </Menu>
            </div>
    ...
    <Drawer :closable="true" width="40" v-model="navDrawerModal" class="header_nav_mobile">
        <Menu :active-name="activeNav" width="auto" @on-select="changelanguage">
            ...
            <Submenu name="lang">
                ...
                <MenuItem name="zh" class="lang-item" style="padding-left:20px!important;"><img src="./assets/images/lang-zh.png">简体中文</MenuItem>
                <MenuItem name="en" class="lang-item" style="padding-left:20px!important;"><img src="./assets/images/lang-en.png">ENGLISH</MenuItem>
            </Submenu>
            <router-link to="/app">
