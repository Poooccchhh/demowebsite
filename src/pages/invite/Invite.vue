  ...
  <div class="invite">
      ...
      <div class="invite-content">
        ...
        <div class="content">
          ...
          <table class="percent-table">
            ...
            <tr><td>L2({{$t('invite.lv2')}})</td><td>10 &lt N ≤ 100</td><td>30% / 12{{$t('invite.month')}}</td><td>10% / 12{{$t('invite.month')}}</td><td></td></tr>
            <tr><td>L3({{$t('invite.lv3')}})</td><td>100 &lt N ≤ 500</td><td>40% / 12{{$t('invite.month')}}</td><td>15% / 12{{$t('invite.month')}}</td><td></td></tr>
            <tr><td>L4({{$t('invite.lv4')}})</td><td>500 &lt N ≤ 1500</td><td>50% / 24{{$t('invite.month')}}</td><td>20% / 24{{$t('invite.month')}}</td><td>+5%</td></tr>
            <tr><td>L5({{$t('invite.lv5')}})</td><td>1500 &lt N ≤ 3000</td><td>60% / 24{{$t('invite.month')}}</td><td>25% / 24{{$t('invite.month')}}</td><td>+10%</td></tr>
            <tr><td>L6({{$t('invite.lv6')}})</td><td>3000 &lt N</td><td>60% / {{$t('invite.alllife')}}</td><td>25% / {{$t('invite.alllife')}}</td><td>+15%</td></tr>
          </table>
      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          <div class="item" @click="showCardItem">
              <img src="https://bizzan.oss-cn-hangzhou.aliyuncs.com/2019/promotioncard.png">
          ...
          <div class="item" @click="useInviteImage">
              <img src="https://bizzan.oss-cn-hangzhou.aliyuncs.com/2019/invitebg.jpg">
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      <div class="ptcard-header">
        <img class="card-img" src="https://bizzan.oss-cn-hangzhou.aliyuncs.com/2019/promotioncard.png">
        <div class="desc">
